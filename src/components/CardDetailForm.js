    ...
    <section className="basis-2/3 flex justify-center items-center">
      <form className="flex flex-col gap-y-4 w-2/5 font-semibold">
        <fieldset className="flex flex-col gap-y-1">
          ...
          <input 
            className="placeholder:text-light-grayish-violet placeholder:font-medium text-sm border border-solid rounded-lg border-light-grayish-violet p-3" 
            id="holderName" 
        ...
        <button className="bg-very-dark-violet text-white rounded-lg py-3">Confirm</button>
      </form>
    </section>
  )
}