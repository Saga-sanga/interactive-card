...
export default function CardGraphics() {
  return(
    <div className="h-screen basis-1/3 graphics flex flex-col justify-center gap-y-9">
      ...
      <div className="relative left-1/2">
        <span className="text-white text-[14px] absolute z-10 top-[45%] right-[20%]">000</span>
